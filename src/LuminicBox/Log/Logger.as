...
class LuminicBox.Log.Logger {
	...
	*/
	...
	private function publish(argument, level:Level,message:String):Void {
		if( level.getValue() >= _level.getValue() ) {
			var e:LogEvent = new LogEvent(this._loggerId, argument, level,message);
	...
	*/
	function log(argument,message):Void { publish(argument, Level.LOG,message); }
	/**
	...
	* @param argument The message or object to inspect.
	*/
	function info(argument,message):Void { publish(argument, Level.INFO,message); }
	/**
	...
	* @param argument The message or object to inspect.
	*/	
	function error(argument,message):Void { publish(argument, Level.ERROR,message); }
	/**
