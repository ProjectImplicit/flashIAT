...
class mx.video.FLVPlayback extends MovieClip {
	...
	public function FLVPlayback() {
		...
		// will be scaled.
		_origHeight =_prevHeight = __height = this._height;
		_origWidth = _prevWidth = __width = this._width;
		_scaleX = 100;
		_scaleY = 100;
		this._xscale = 100;
		this._yscale = 100;
	...
	public function seekPercent(percent:Number):Void {
		...
		if ( percent < 0 || percent > 100 ||
		     _vp[_activeVP].totalTime == undefined ||
	...
	{
		if ( _vp[_activeVP].totalTime == undefined ||
		     _vp[_activeVP].totalTime == null ||
		     _vp[_activeVP].totalTime <= 0 ) {
			return undefined;
		}
	...
	public function get bufferingBar():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _bufferingBar = _uiMgr.getControl(UIManager.BUFFERING_BAR);
		return _bufferingBar;
	}
	public function set bufferingBar(s:MovieClip):Void {
		_bufferingBar = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.BUFFERING_BAR, s);
	}
	...
	public function get backButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _backButton = _uiMgr.getControl(UIManager.BACK_BUTTON);
		return _backButton;
	}
	public function set backButton(s:MovieClip):Void {
		_backButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.BACK_BUTTON, s);
	}
	...
	public function get forwardButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _forwardButton = _uiMgr.getControl(UIManager.FORWARD_BUTTON);
		return _forwardButton;
	}
	public function set forwardButton(s:MovieClip):Void {
		_forwardButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.FORWARD_BUTTON, s);
	}
	...
	public function get muteButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _muteButton = _uiMgr.getControl(UIManager.MUTE_BUTTON);
		return _muteButton;
	}
	public function set muteButton(s:MovieClip):Void {
		_muteButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.MUTE_BUTTON, s);
	}
	...
	public function get pauseButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _pauseButton = _uiMgr.getControl(UIManager.PAUSE_BUTTON);
		return _pauseButton;
	}
	public function set pauseButton(s:MovieClip):Void {
		_pauseButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.PAUSE_BUTTON, s);
	}
	...
	public function get playButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _playButton = _uiMgr.getControl(UIManager.PLAY_BUTTON);
		return _playButton;
	}
	public function set playButton(s:MovieClip):Void {
		_playButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.PLAY_BUTTON, s);
	}
	...
	public function get playPauseButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _playPauseButton = _uiMgr.getControl(UIManager.PLAY_PAUSE_BUTTON);
		return _playPauseButton;
	}
	public function set playPauseButton(s:MovieClip):Void {
		_playPauseButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.PLAY_PAUSE_BUTTON, s);
	}
	...
	public function get seekBar():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _seekBar = _uiMgr.getControl(UIManager.SEEK_BAR);
		return _seekBar;
	}
	public function set seekBar(s:MovieClip):Void {
		_seekBar = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.SEEK_BAR, s);
	}
	...
	public function set seekBarInterval(s:Number) {
		_seekBarInterval = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.seekBarInterval = _seekBarInterval;
	}
	...
	public function get seekBarScrubTolerance():Number {
		if (_uiMgr != null && _uiMgr != undefined) _seekBarScrubTolerance = _uiMgr.seekBarScrubTolerance;
		return _seekBarScrubTolerance;
	}
	public function set seekBarScrubTolerance(s:Number) {
		_seekBarScrubTolerance = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.seekBarScrubTolerance = _seekBarScrubTolerance;
	}
	...
	public function get skin():String {
		if (_uiMgr != null && _uiMgr != undefined) _skin = _uiMgr.skin;
		return _skin;
	}
	public function set skin(s:String):Void {
		_skin = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.skin = s;
	}
	...
	public function get skinAutoHide():Boolean {
		if (_uiMgr != null && _uiMgr != undefined) _skinAutoHide = _uiMgr.skinAutoHide;
	...
	public function set skinAutoHide(b:Boolean):Void {
		...
		if (_global.isLivePreview) return;
		_skinAutoHide = b;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.skinAutoHide = b;
	}
	...
	public function get stopButton():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _stopButton = _uiMgr.getControl(UIManager.STOP_BUTTON);
		return _stopButton;
	}
	public function set stopButton(s:MovieClip):Void {
		_stopButton = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.STOP_BUTTON, s);
	}
	...
	public function set visibleVideoPlayerIndex(i:Number) {
		...
		if (_firstStreamShown) {
			_uiMgr.setupSkinAutoHide(oldIndex);
	...
	public function get volumeBar():MovieClip {
		if (_uiMgr != null && _uiMgr != undefined) _volumeBar = _uiMgr.getControl(UIManager.VOLUME_BAR);
		return _volumeBar;
	}
	public function set volumeBar(s:MovieClip):Void {
		_volumeBar = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.setControl(UIManager.VOLUME_BAR, s);
	}
	...
	public function set volumeBarInterval(s:Number) {
		...
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.volumeBarInterval = _volumeBarInterval;
	}
	...
	public function get volumeBarScrubTolerance():Number {
		if (_uiMgr != null && _uiMgr != undefined) _volumeBarScrubTolerance = _uiMgr.volumeBarScrubTolerance;
		return _volumeBarScrubTolerance;
	}
	public function set volumeBarScrubTolerance(s:Number) {
		_volumeBarScrubTolerance = s;
		if (_uiMgr != null && _uiMgr != undefined) _uiMgr.volumeBarScrubTolerance = _volumeBarScrubTolerance;
	}
	...
	//	if (_debuggingOn) {
	//		if (_debugFn != null && _debugFn != undefined) {
