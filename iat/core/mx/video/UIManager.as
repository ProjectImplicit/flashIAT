...
class mx.video.UIManager {
	 ...
	 * UIManager.
	 */
	// todo: buffeirng ui changes delay for 1 sec
	// todo: buffering disables play for bufferTime secs (-1 sec delay)
	// todo: buffering goes from seekBar to buffering animation
	...
	private function fixUpBar(ctrl:MovieClip, type:String):Void {
		if (ctrl[type + "LinkageID"] != undefined && ctrl[type + "LinkageID"].length > 0) {
			...
			ctrl[type + "_mc"] = ctrl._parent.attachMovie(ctrl[type + "LinkageID"], type + "_mc", depth);
		}
	}
